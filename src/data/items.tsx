    ...
    parentCatCollection: [
      {
        ...
        items: [
          ...
          {itemName:'Cheese Platter',price:'450',description:'3 Cheese + Crackers + Assorted Olives + Fresh Fruits',image:cheese_platter,allergies:['free_from_wheat,refined_sugar,eggs '],packaging:'1pc',yield:'Serves 6'},
          {itemName:'Cheese Platter ',price:'600',description:'4 Cheese + Crackers + Assorted Olives + Fresh Fruits',image:placeholder,allergies:['free_from_wheat,refined_sugar,eggs '],packaging:'1pc',yield:'Serves 10'},
      ],
      },
    ],
  },
